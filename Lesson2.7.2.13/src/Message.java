...
public static class MailMessage extends Message {
...
public static class Salary extends Message {
...
public static class MailService<T> extends HashMap implements Consumer<Message> {
